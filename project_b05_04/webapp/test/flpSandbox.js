		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "JSON CRUD",
									"targetURL": "#projectb0504-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectb0504-display": {
								"semanticObject": "projectb0504",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectb0504",
									"url": sap.ui.require.toUrl("projectb0504")
								}
							}
						}
					}
