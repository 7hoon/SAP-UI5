		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "계정과목 CRUD 프로그램",
									"targetURL": "#zprojectzbbfi010-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zprojectzbbfi010-display": {
								"semanticObject": "zprojectzbbfi010",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zprojectzbbfi010",
									"url": sap.ui.require.toUrl("zprojectzbbfi010")
								}
							}
						}
					}
