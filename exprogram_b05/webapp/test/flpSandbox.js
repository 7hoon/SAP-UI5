		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "항공편 조회 (B05)",
									"targetURL": "#examexprogramb05-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"examexprogramb05-display": {
								"semanticObject": "examexprogramb05",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exam.exprogramb05",
									"url": sap.ui.require.toUrl("exam/exprogramb05")
								}
							}
						}
					}
