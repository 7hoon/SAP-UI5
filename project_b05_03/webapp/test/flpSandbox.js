		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#Testprojectb0503-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Testprojectb0503-display": {
								"semanticObject": "Testprojectb0503",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Test.projectb0503",
									"url": sap.ui.require.toUrl("Test/projectb0503")
								}
							}
						}
					}
