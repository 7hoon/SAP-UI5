		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "자재사용량 조회",
									"targetURL": "#zbbproject030-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbbproject030-display": {
								"semanticObject": "zbbproject030",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbbproject030",
									"url": sap.ui.require.toUrl("zbbproject030")
								}
							}
						}
					}
