		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Chart",
									"targetURL": "#projectb0507-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectb0507-display": {
								"semanticObject": "projectb0507",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectb0507",
									"url": sap.ui.require.toUrl("projectb0507")
								}
							}
						}
					}
