		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "부서 조회 프로그램",
									"targetURL": "#zbbprojectfi010-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbbprojectfi010-display": {
								"semanticObject": "zbbprojectfi010",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbbprojectfi010",
									"url": sap.ui.require.toUrl("zbbprojectfi010")
								}
							}
						}
					}
