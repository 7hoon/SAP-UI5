		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "NorthWind",
									"targetURL": "#projectb0506-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectb0506-display": {
								"semanticObject": "projectb0506",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectb0506",
									"url": sap.ui.require.toUrl("projectb0506")
								}
							}
						}
					}
