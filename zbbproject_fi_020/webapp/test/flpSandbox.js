		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "수익성 분석 ",
									"targetURL": "#zbbprojectfi020-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbbprojectfi020-display": {
								"semanticObject": "zbbprojectfi020",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbbprojectfi020",
									"url": sap.ui.require.toUrl("zbbprojectfi020")
								}
							}
						}
					}
