		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "테스트용",
									"targetURL": "#projectb0599-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectb0599-display": {
								"semanticObject": "projectb0599",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectb0599",
									"url": sap.ui.require.toUrl("projectb0599")
								}
							}
						}
					}
