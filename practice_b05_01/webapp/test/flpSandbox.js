		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "연습1",
									"targetURL": "#practiceb0501-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"practiceb0501-display": {
								"semanticObject": "practiceb0501",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=practiceb0501",
									"url": sap.ui.require.toUrl("practiceb0501")
								}
							}
						}
					}
