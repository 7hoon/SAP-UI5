		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My App",
									"targetURL": "#zprojectb0509-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zprojectb0509-display": {
								"semanticObject": "zprojectb0509",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zprojectb0509",
									"url": sap.ui.require.toUrl("zprojectb0509")
								}
							}
						}
					}
